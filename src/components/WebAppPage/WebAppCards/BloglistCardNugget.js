      ...
      >
        ...
        <Text fontSize="lg" mb={4}>
          <List spacing={3}>
            ...
            <ListItem>
              <ListIcon as={MdCheckCircle} color="green.500" />
              Blog posts include essential details like <b>
                name, author,
              </b> and <b>URL.</b>
            </ListItem>
            <ListItem>
              <ListIcon as={MdCheckCircle} color="green.500" />
              Only blog creators can delete their posts, enforced in{" "}
              <b>both frontend and backend.</b>
            </ListItem>
            <ListItem>
              <ListIcon as={MdCheckCircle} color="green.500" />
              Users can 'like' blogs, with popular ones sorted to the top of the
              list.
            </ListItem>
            <ListItem>
              <ListIcon as={MdCheckCircle} color="green.500" />
              Separate versions for <b>MySQL</b> and <b>MongoDB databases.</b>
            </ListItem>
          </List>
        </Text>
        <Text
