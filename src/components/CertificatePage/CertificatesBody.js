          ...
          <CardBody>
            ...
            <Stack mt="6" spacing="3">
              ...
              >
                <ModalOverlay />
                <ModalContent>
                  <ModalHeader>Diploma and Transcript</ModalHeader>
                  <ModalCloseButton />
                  <ModalBody>
                    <Box>
                      <Text
                      ...
                      >
                        {" "}
                        <strong>
                          How to download my Diploma and Transcript
                        </strong>
                      </Text>
                      <Text fontSize="lg" mb={4}>
                        <strong>Step 1:</strong> Download the opencert files:{" "}
                        <a
                      ...
                      <Text fontSize="lg" mb={4}>
                        <strong>Step 2:</strong> Unzip the zip folder, revealing
                        2 opencert files.
                      </Text>
                      <Text fontSize="lg" mb={4}>
                        <strong>Step 3:</strong> Open this webpage:{" "}
                        <a
                      ...
                      <Text fontSize="lg" mb={10}>
                        <strong>Step 4:</strong> Insert the files into the
                        webpage to verify the files.
                      </Text>
                      <Divider></Divider>

                      <Text fontSize="lg" mb={4}>
                        If the download link <strong>isn't working</strong>,
                        please try a different browser (like Edge) or contact me
                        at <strong>nicholastengshin@hotmail.com</strong> for the
                        files instead. 😊
                      </Text>
                    </Box>
                  </ModalBody>
                  ...
                  <ModalFooter>
                    <Button
                      colorScheme="blue"
                      mr={3}
                      onClick={onHighestQualificationClose}
                    >
                      Close
                    </Button>
                  </ModalFooter>
