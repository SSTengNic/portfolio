  ...
  return (
    ...
    >
      <Text textAlign="left" ml={2} mb={3} spacing="">
        Seeing the need for more <b>student-focused deals</b>, my friends and I
        created PinchPromo—a web app that brings exclusive student discounts💰
        to life through gamification!😎 Click here to learn more.
      </Text>
