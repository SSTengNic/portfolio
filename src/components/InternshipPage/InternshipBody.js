...
import SimplifyNextPic from "../../pictures/Internship_Thumbnails/simplifynext_logo.jpg";
    ...
    <>
      ...
      >
        <SimplifyNextCardNugget
          ...
          subheading={ObjectsToUse.SimplifyNextObject.subheading}
          isModalOpen={isSimplifyNextModalOpen}
          onModalOpen={onSimplifyNextOpen}
          onModalClose={onSimplifyNextClose}
          thumbnailPic={SimplifyNextPic}
          cardHeader={ObjectsToUse.SimplifyNextObject.cardHeader}
          modalHeader={ObjectsToUse.SimplifyNextObject.modalHeader}
          modalBodyHeading1={ObjectsToUse.SimplifyNextObject.modalBodyHeading1}
          modalBodyHeading2={ObjectsToUse.SimplifyNextObject.modalBodyHeading2}
          modalBodyVideo={ObjectsToUse.SimplifyNextObject.modalBodyVideo}
        ...
        <TCCCardNugget
          ...
          subheading={ObjectsToUse.TCCObject.subheading}
          ...
          modalBodyDescription1={ObjectsToUse.TCCObject.modalBodyDescription1}
          modalBodyDescription2={ObjectsToUse.TCCObject.modalBodyDescription2}
          modalBodyDescription3={ObjectsToUse.TCCObject.modalBodyDescription3}
        />
      </Flex>
    </>
  );
