...
const TCCObject = {
    ...
    modalBodyDescription3: `Morever, I transformed an internal tool, originally built using Dash for prototyping, into a fully deployed full-stack web application. This involved refactoring the existing code, integrating a robust Flask backend to handle server-side logic, and implementing a MySQL database to manage and store the tool’s content. The entire application was then successfully deployed using AWS Elastic Beanstalk and AWS Relational Database Service (RDS), ensuring scalability and efficient database management. This transition from prototype to production involved streamlining performance, improving maintainability, and providing a more seamless user experience.`,
};
